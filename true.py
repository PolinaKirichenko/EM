...
def real_params(i):
  real = [
    ...
    Gauss(np.loadtxt("true_center/dim015.txt"),
          np.full((3, 15, 15), np.eye(15))),

    Gauss(np.loadtxt("true_center/m15_5.txt"),
          np.full((5, 15, 15), np.eye(15))),


    Gauss(np.loadtxt("true_center/30.txt"),
          np.full((3, 30, 30), np.eye(30))),

    Gauss(np.loadtxt("true_center/dim030.txt"),
